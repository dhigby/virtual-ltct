...
![The Run basic checks dialog with Quotations ticked, Choose Books selected, and all NT books included.](assets/ss-01-run-basic-checks.png)

5. Look at the results list.

![The Quotations check results panel with no results at all, showing only the notice "Quotation punctuation is not used in project TAMBA" and pointing to Project settings > Quotation rules.](assets/ss-01-unconfigured-results.png)
