...
![A Compare Versions dialog for two parallel verses, with the changed word highlighted in green on one side and pink on the other.](images/L3-4c.PP-compare.png)
