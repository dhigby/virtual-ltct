...
[One or two sentences, framed as an observable outcome — this should trace back to the
module's `target_outcome_level` and the competency descriptor under `competencies/`.]

## Content

[Core teaching content goes here.]

## Check your understanding

[A short in-line check (not the full quiz) — optional, use if the lesson is long enough
to warrant a checkpoint before moving on.]
