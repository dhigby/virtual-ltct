# MODULE 1: UNDERSTANDING LAPTOP SYSTEMS
...
- Identify the major hardware components inside a laptop
...
> **Having difficulties with anything?** Try the [chipp.ai](http://chipp.ai/) assistant for
> this course — it can talk you through any of the material at your own pace.
...
This course focuses on **laptops** because that's what most language workers use in the field.

#### Course Structure

- **Module 1 (65 min):** Understanding how laptop hardware works
- **Module 2 (85 min):** Diagnosing hardware problems systematically
- **Module 3 (65 min):** Making practical decisions and applying your knowledge
- **Module 4 (70 min):** Power, safety and data protection in the field

#### What You'll Need

- Your own laptop to explore
...
Throughout Modules 2, 3 and 4, you'll work through realistic scenarios. Your mentor will review your diagnostic plans and provide feedback. There is also a [quiz](07-quiz.md) covering all four modules — 27 questions, 80% (22/27) to pass.

---

## Content

### Section 1.2: What's Inside a Laptop?

**Time:** 20 minutes

#### Introduction

Before you can troubleshoot hardware problems, you need to understand what's actually inside a laptop. In this section, you'll take a visual tour inside a typical laptop and learn what each major component does.

#### Activity 1.2a: Visual Teardown Tour

**Time:** 10 minutes

We're going to look inside a laptop using professional teardown guides. Don't worry - you won't be opening your own computer! But seeing the internal components will help you understand how everything fits together.
...
2. **Choose a teardown to view:**
   1. Search for "laptop teardown" or pick any recent laptop model
...
3. **As you view the teardown, identify these key components.** Take notes on what you see for each component:
   1. **Bottom cover/case**
...
- Your CPU:
- Your RAM:
- Your storage type and capacity:
- Your battery health (if shown):
...
**Time:** 20 minutes (includes Activities 1.4a and 1.4b)
...
- **A swelling battery** — the most dangerous heat symptom. Heat makes a lithium battery
  generate gas internally, and the pack physically expands. You'll cover how to spot this and
  what to do in [Module 4](04-module-4.md); for now, know that heat doesn't just shorten
  battery life, it can turn a battery into a fire risk.

#### 2. Dust

**Effects on hardware:**

- Clogs cooling vents (leads to overheating) — this is by far the main problem
- Forms an insulating blanket on components, so heat can't radiate away
- Packs into the heat sink fins, where it's much harder to remove than surface dust
- Combined with humidity, forms a conductive grime that can bridge electrical contacts

You'll sometimes hear that dust causes static discharge. It doesn't really — dust is an
insulator. Think of dust as a *thermal* problem (blocked airflow, trapped heat) and, when it
gets damp, a *contamination* problem. Both are worth preventing; neither is static.
...
Of the four environmental factors, this is the one most likely to destroy hardware outright
rather than wear it down — and it's the one most often protected against with the wrong
equipment. Module 4 covers what to actually recommend; here, learn to recognise it.

"Bad power" is really **three different problems**, and they need different protection:

| Problem | What it is | What it does |
| --- | --- | --- |
| **Surge / spike** | A brief, very high voltage transient — lightning, grid switching | Punches through power circuitry; can kill instantly |
| **Sag / brownout** | Voltage drops below normal for seconds to hours | Makes the adapter work harder and run hot; the slow killer of power bricks |
| **Over-voltage / swell** | Voltage sits above normal for a sustained period | Cooks the adapter and charging circuit over weeks |

Most people know about surges and buy a surge protector. **Sags and swells are the more common
field problem, and a surge protector does nothing about them** — that's the single most
important thing to understand about power in this course, and Module 4 covers what to do
instead.

**Effects on hardware:**

- Voltage spikes damage power circuitry
- Sustained low or high voltage cooks the power adapter — usually the first thing to die
- Frequent outages stress power adapter and battery
- Abrupt power loss mid-write can corrupt data on storage drives
...
- ✓ What's inside a laptop and how to identify major components
- ✓ How components interact as a system
- ✓ How environmental factors (heat, dust, humidity, power) affect hardware
- ✓ That "bad power" is three distinct problems — surge, sag, and swell — needing different protection
...
- Dust is a heat problem, not a static problem — and heat is what eventually swells batteries
...
**Ready for Module 2?** Now that you understand what's inside and how it works, you'll learn how to systematically diagnose hardware problems.
